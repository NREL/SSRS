"""Script for running the simple heuristic simulation near Shirley Basin at 30-m resolution"""
...
config_base = Config(
    ...
    southwest_lonlat=(-106.31, 41.86),  # (lon, lat) for southwest pt - no integers
    region_width_km=(25., 25.),  # terrain width (xwidth, ywidth) in km
    resolution=30., # meters
    
    track_direction=337.5, #202.5 = SSW, 157.5=SSE, 337.5=NNW
    track_start_region=(2., 23., 0.5, 0.5),  #xmin, xmax, ymin, ymax
